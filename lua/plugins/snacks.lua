return {
  ...
  keys = {
    ...
    { "<leader>:", function() Snacks.picker.command_history() end, desc = "Find command history" }, -- shortcut
    { "<leader>;", function() Snacks.picker.buffers() end, desc = "Find buffers" }, -- shortcut
