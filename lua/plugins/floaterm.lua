return {
	...
	config = function()
		...
		vim.keymap.set("n", "<A-s>", function()
			smart_toggle_terminal("split", "--wintype=split --height=0.3")
		end, { silent = true, desc = "Smart toggle split terminal" })
		vim.keymap.set("n", "<A-v>", function()
			smart_toggle_terminal("vsplit", "--wintype=vsplit --width=0.5")
		end, { silent = true, desc = "Smart toggle vsplit terminal" })
		vim.keymap.set("n", "<A-f>", function()
			smart_toggle_terminal("float", "--wintype=float --width=0.8 --height=0.8")
		end, { silent = true, desc = "Smart toggle float terminal" })
		...
		vim.api.nvim_create_autocmd("FileType", {
			...
			callback = function()
				...
				vim.keymap.set(
					...
					"<C-h>",
					[[<C-\><C-n><C-w>h]],
					{ buffer = true, silent = true, desc = "Move to left window" }
				)
				vim.keymap.set(
					"t",
					"<C-j>",
					[[<C-\><C-n><C-w>j]],
					{ buffer = true, silent = true, desc = "Move to bottom window" }
				)
				vim.keymap.set(
					"t",
					"<C-k>",
					[[<C-\><C-n><C-w>k]],
					{ buffer = true, silent = true, desc = "Move to top window" }
				)
				vim.keymap.set(
					"t",
					"<C-l>",
					[[<C-\><C-n><C-w>l]],
					{ buffer = true, silent = true, desc = "Move to right window" }
				)
				...
				vim.keymap.set(
					"t",
					"<A-s>",
					[[<C-\><C-n>:lua smart_toggle_terminal("split", "--wintype=split --height=0.3")<CR>]],
					{ buffer = true, silent = true, desc = "Smart toggle split terminal" }
				)
				vim.keymap.set(
					"t",
					"<A-v>",
					[[<C-\><C-n>:lua smart_toggle_terminal("vsplit", "--wintype=vsplit --width=0.3")<CR>]],
					{ buffer = true, silent = true, desc = "Smart toggle vsplit terminal" }
				)
				vim.keymap.set(
					"t",
					"<A-f>",
					[[<C-\><C-n>:lua smart_toggle_terminal("float", "--wintype=float --width=0.8 --height=0.8")<CR>]],
					{ buffer = true, silent = true, desc = "Smart toggle float terminal" }
				)
