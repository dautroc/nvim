return {
	...
	keys = {
		{ "<leader>jd", "<cmd>Journal day<CR>", desc = "Day" },
		{ "<leader>jw", "<cmd>Journal week<CR>", desc = "Week" },
		{ "<leader>jm", "<cmd>Journal month<CR>", desc = "Month" },
		{ "<leader>jy", "<cmd>Journal year<CR>", desc = "Year" },
	},
	config = function()
