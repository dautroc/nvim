...
return {
	...
	config = function(_, opts)
        ...
        -- NOTE: Zip the current file or directory and copy it to the system clipboard
				...
				-- NOTE: Paste the current file or directory from the system clipboard into the current directory in mini.files
        ...
        -- NOTE: This is useful for pasting the path in the terminal or other applications
				...
				-- NOTE: Preview the selected image in a neovim popup window
